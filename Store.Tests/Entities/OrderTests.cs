...
namespace Store.Tests.Domain
{
    ...
    {
        private readonly Customer _customer = new Customer("Caio Cesar", "caiocsmeneghelli@ig.com");
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_pagamento_do_pedido_seu_status_dever_ser_aguardando_entrega()
        {
            var order = new Order(_customer, 0, null);
        ...
        {
            var order = new Order(_customer, 0, null);
            var product = new Product("Produto 2", 10, true);
        ...
        public void Dado_um_novo_pedido_valido_seu_total_deve_ser_50()
        {
            ...
            var produto = new Product("Produto 2", 10, true);
            order.AddItem(_product, 1);
            order.AddItem(produto, 4);
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_cliente_nulo_pedido_deve_ser_invalido()
        {
